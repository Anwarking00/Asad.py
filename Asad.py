...
lol = (f"""\33[1;92m
     ...
     _          _     _            _       
  __| |__ _ _ _| |__ | |_  __ _ __| |_____ 
 / _` / _` | '_| / / | ' \/ _` / _| / / -_)
 \__,_\__,_|_| |_\_\ |_||_\__,_\__|_\_\___|                                                
...
os.system('xdg-open https://youtube.com/@lklklk25?si=OzN66-y_0cgKMdl6')
name=fuckx.upper()
...
def banner():
 ...
 \__,_\__,_|_| |_\_\ |_||_\__,_\__|_\_\___|        
   \033[1;93m𝙉\033[1;94m𝙊\033[1;91m𝘽\033[1;92m𝙄\033[1;95m𝙏\033[1;90m𝘼\033[1;92m-\033[1;91m𝙑\033[1;94m𝙄\033[1;93m𝙍\033[1;96m𝙐\033[1;95m𝙎
     ...
     {H} ╔════════════════════════{M}════════════════╗
      {H}║{M}[{H}•{M}] AUTHOR    :{H} MD Nayeem             {N}{M}║
      {H}║{M}[{H}•{M}] FACEBOOK  : {H}MD Nayeem            {N}{M}║
      {H}║{M}[{H}•{M}] GITHUB    : {H}Dark hack{N}       {H}  ║
      {M}║{M}[{H}•{M}] STATUS    : {H}INFINITY -X{P}     {N}  {H}      ║
      {M}║{M}[{H}•{M}] VERSION   : {H}1.0.1                  {H} ║
      {M}╚═════════════{H}═══════════════════════════╝ {P}""")
...
def main():
    ...
    print(f'{M}╚══[•] CODER NAME: {H}MD Nayeem')
    print(f' ')
    ...
    if sh =='1':
       os.system('xdg-open https://m.facebook.com/groups/youtubechannelsale64/?ref=share&mibextid=NSMWBT/')
       _xxx_()
    if sh =='2':
       os.system('xdg-open https://m.facebook.com/groups/youtubechannelsale64/?ref=share&mibextid=NSMWBT/')
       main()
...
def user():
    ...
    print(f"")   
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'    {P}[{H}√{P}] EXAMPLE    : {K}50000/100000/200000')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f"")
    limit = int(input(f'    %s[%s?%s] CRACK ID LIMIT : %s'%(N,K,N,H)))
    for nmbr in range(limit):
